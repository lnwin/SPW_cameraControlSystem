...
Rectangle {
    ...
    ColumnLayout {
        ...
        ColumnLayout {
            ...
            RowLayout {
                Layout.fillWidth: true
                Text { text: "截图保存路径"; color: "#9aa0a6"; font.pixelSize: 12; font.family: "Microsoft YaHei UI"; width: 100 }
                Rectangle {
            ...
            RowLayout {
                Layout.fillWidth: true
                Text { text: "录像保存路径"; color: "#9aa0a6"; font.pixelSize: 12; font.family: "Microsoft YaHei UI"; width: 100 }
                Rectangle {
                    Layout.fillWidth: true; height: 26
                    color: "#0a1a12"; border.color: "#00cc88"; border.width: 1; radius: 2
                    TextInput {
            ...
            RowLayout {
                Layout.fillWidth: true
                Text { text: "截图格式"; color: "#9aa0a6"; font.pixelSize: 12; font.family: "Microsoft YaHei UI"; width: 100 }
                Repeater {
                    model: ["PNG", "JPG", "BMP"]
                    delegate: Rectangle {
            ...
            RowLayout {
                Layout.fillWidth: true
                Text { text: "录像格式"; color: "#9aa0a6"; font.pixelSize: 12; font.family: "Microsoft YaHei UI"; width: 100 }
                Repeater {
                    model: ["MP4", "AVI"]
                    delegate: Rectangle {
                        width: 60; height: 26; radius: 2
            ...
            RowLayout {
                Layout.fillWidth: true
                Text { text: "录像叠加信息"; color: "#9aa0a6"; font.pixelSize: 12; font.family: "Microsoft YaHei UI"; width: 100 }
                Rectangle {
                ...
                Text { text: "录像/截图时保存叠加时间信息"; color: "#9aa0a6"; font.pixelSize: 11; font.family: "Microsoft YaHei UI" }
            }
